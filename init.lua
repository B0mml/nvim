...
vim.keymap.set('t', '<C-e><C-e>', [[<C-\><C-n>]], { desc = 'Exit terminal mode' })
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      local function section_copilot()
        ...
        local icons = {
          enabled = vim.g.have_nerd_font and '' or 'AI',
          disabled = vim.g.have_nerd_font and '' or 'AI!',
        }

        -- Use the official Copilot function to check if enabled
        local enabled = vim.fn['copilot#Enabled']()

        return enabled == 1 and icons.enabled or icons.disabled
      end

      -- Override the default active content to include Copilot
      ...
      statusline.active = function()
        ...
        local copilot = section_copilot() -- Add Copilot indicator
        ...
        return statusline.combine_groups {
          ...
          { hl = 'MiniStatuslineDevinfo', strings = { copilot } },
